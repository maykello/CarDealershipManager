    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarStatusModel", x => x.CarStatusId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EuroClassId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EuroClasses", x => x.EuroClassId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EuroClassId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cars_EuroClasses_EuroClassId",
                        column: x => x.EuroClassId,
                        principalTable: "EuroClasses",
                        principalColumn: "EuroClassId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
